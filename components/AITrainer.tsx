      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-black text-white mb-4">
            4FIT <span className="text-green-500">A.I.</span> TRAINER
          </h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
          {/* Controls */}
          <div className="lg:col-span-4 space-y-8 bg-black/50 p-8 rounded-3xl border border-zinc-800 h-fit">
            <div>
            ...
            <div>
              ...
              <select 
                ...
                className="w-full bg-zinc-800 border-none rounded-xl p-4 text-white focus:ring-2 focus:ring-green-500 outline-none appearance-none"
              >
              ...
              <div className="bg-zinc-950 border border-zinc-800 rounded-3xl p-8 shadow-2xl animate-fade-in-up">
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 border-b border-zinc-800 pb-6">
                  <div>
                    ...
                    <p className="text-green-400 font-mono mt-2">{plan.duration}</p>
                  </div>
                ...
                <div className="space-y-4">
                  {plan.exercises.map((ex, idx) => (
                    <div key={idx} className="bg-zinc-900/50 p-6 rounded-xl border-l-4 border-green-500 hover:bg-zinc-800 transition-colors">
