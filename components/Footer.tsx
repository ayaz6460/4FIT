      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-3 text-gray-500">
              <li className="hover:text-green-500 cursor-pointer transition-colors">About Us</li>
              <li className="hover:text-green-500 cursor-pointer transition-colors">Classes</li>
              <li className="hover:text-green-500 cursor-pointer transition-colors">Trainers</li>
          ...
          <div>
            ...
            <ul className="space-y-3 text-gray-500">
              <li className="flex items-start">
                <svg className="w-5 h-5 mr-3 text-green-500 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" /><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" /></svg>
              ...
              <li className="flex items-center">
                 <svg className="w-5 h-5 mr-3 text-green-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" /></svg>
                namaste@4fitgym.in
              </li>
            </ul>
          </div>
        ...
        <div className="border-t border-zinc-900 pt-8 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-6 mt-4 md:mt-0">
             ...
             <div className="w-6 h-6 bg-zinc-800 rounded-full hover:bg-green-500 cursor-pointer transition-colors"></div>
             <div className="w-6 h-6 bg-zinc-800 rounded-full hover:bg-green-500 cursor-pointer transition-colors"></div>
             <div className="w-6 h-6 bg-zinc-800 rounded-full hover:bg-green-500 cursor-pointer transition-colors"></div>
          </div>
        </div>
